...
struct ImFont
{
    ...
    IMGUI_API const char*       CalcWordWrapPosition(float size, ImStrv text, float wrap_width);
    ...
    inline    const char*       CalcWordWrapPositionA(float scale, const char* text, const char* text_end, float wrap_width)                                              { return CalcWordWrapPosition(FontSize * scale, ImStrv(text, text_end), wrap_width); }
